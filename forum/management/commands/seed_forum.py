...
SEED_TOPICS = [
    ...
    },
    {
        ...
        "replies": [
            ...
            {
                "author": "Ganger_Kroll",
                "content": "Эй, а этот Конрад Кёрз... звучит как парень из наших низов. У нас тут в секторе 4 тоже есть свои 'повелители ночи', только они за чистую воду режут глотки, а не дворцы строят. А эти 'примархи' — они вообще к нам в подулей заглядывают?",
                "replies": [
                    {
                        "author": "Trader_Von_Valancius",
                        "content": "О, святое невежество низов... Радуйся, отброс, что твой мир-улей никогда не привлекал внимания Легионов — ни лоялистов, ни предателей. Я пересекал Простор Коронус и видел планеты, расколотые их гневом до самого ядра. Поверь, ты не хочешь, чтобы они 'заглянули' к тебе."
                    },
                    {
                        "author": "Arbites_Lex",
                        "content": "Гражданин Кролл, сравнение святых примархов с криминальным элементом подулья является богохульством. Наряд Арбитрес уже выехал в ваш сектор для проведения воспитательной беседы."
                    }
                ]
            },
        ]
    },
    {
        "community_title": "Нижний Улей",
        "author": "Hive_Scum_99",
        "title": "Мега-обсуждение: Кто украл мои ботинки?",
        "content": "Кто-то спер мои ботинки, пока я спал в секторе 4. Подозреваю всех.",
        "images": None,
        "replies": [
            {
                "author": "Ganger_Kroll",
                "content": f"Это не я! Я в это время был на смене. (Оправдание №{i})"
